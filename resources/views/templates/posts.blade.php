@foreach ($posts as $post)
    <div class="container " id="post-container">
        <div class="post bg-white py-4">
            <h2 class="post-title">{{ cutString($post['title']) }}</h2>
        ...
        <a class="text-gray-500 hover:text-orange" href="/posts/{{ $post['id'] }}/comments/index">
        ...
        <a class="text-gray-500 hover:text-orange" href="/user/posts/{{ $post['id'] }}/like"
        ...
        <a class="text-gray-500 hover:text-orange" href="/user/posts/{{ $post['id'] }}/dislike"
            style="display: inline-block; ">
            <svg style="display: inline-block; margin-left: 10px; margin-top: -3px;" width="15px" height="15px"
                viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg">
                <defs>
